...
(function ($) {
  ...
  Calendar.prototype = {
    ...
    _initializeOptions: function (opt) {
      ...
      this.options = {
        //@tqcenglish@gmail.com
        highlightDay: opt.highlightDay || [
          0, 6
        ],
    ...
    _initializeEvents: function (opt) {
      ...
      if (opt.renderEnd) {
        this
          .element
          .bind('renderEnd', opt.renderEnd);
      }
      if (opt.clickDay) {
        this
          .element
          .bind('clickDay', opt.clickDay);
      }
      if (opt.dayContextMenu) {
        this
          .element
          .bind('dayContextMenu', opt.dayContextMenu);
      }
      if (opt.selectRange) {
        this
          .element
          .bind('selectRange', opt.selectRange);
      }
      if (opt.mouseOnDay) {
        this
          .element
          .bind('mouseOnDay', opt.mouseOnDay);
      }
      if (opt.mouseOutDay) {
        this
          .element
          .bind('mouseOutDay', opt.mouseOutDay);
      }
    },
    ...
    _renderBody: function () {
      ...
      for (var m = 0; m < 12; m++) {
        ...
        titleCell.attr('colspan', this.options.displayWeekNumber
          ? 8
          : 7);
      ...
      switch (this.options.style) {
        case 'border':
          ...
          if (events.length == 1) {
            ...
            elt
              .parent()
              .css('box-shadow', 'inset 0 -4px 0 0 black');
          }
        ...
        case 'background':
          elt
            .parent()
            .css('background-color', events[events.length - 1].color);
          ...
          if (events[events.length - 1].startDate.getTime() == currentTime) {
            ...
            if (events[events.length - 1].startHalfDay || this.options.alwaysHalfDay) {
              ...
              elt
                .parent()
                .css('background', 'linear-gradient(-45deg, ' + events[events.length - 1].color + ', ' + events[events.length - 1].color + ' 49%, ' + otherColor + ' 51%, ' + otherColor + ')');
            ...
            if (events[events.length - 1].endHalfDay || this.options.alwaysHalfDay) {
              ...
              elt
                .parent()
                .css('background', 'linear-gradient(135deg, ' + events[events.length - 1].color + ', ' + events[events.length - 1].color + ' 49%, ' + otherColor + ' 51%, ' + otherColor + ')');
            } else if (this.options.roundRangeLimits) {
              elt
                .parent()
        ...
        case 'custom':
          if (this.options.customDataSourceRenderer) {
            this
              ...
              .call(this, elt, currentDate, events);
          }
          break;
      }
    },
    _applyEvents: function () {
      ...
      this
        .element
        .find('.year-neighbor, .year-neighbor2')
        .click(function () {
    ...
    _refreshRange: function () {
      ...
      this
        .element
        .find('td.day.range-start')
        .removeClass('range-start');
      this
        .element
        .find('td.day.range-end')
    ...
    _getDate: function (elt) {
      var day = elt
        .children('.day-content')
        .text();
      var month = elt
        .closest('.month-container')
        .data('month-id');
